_Note: This script is mostly the same as [Bash history cleaner](https://github.com/sglavoie/python-utilities/tree/master/bash_history_cleaner), slightly adapted to work for Zsh._
